...
public:
	...
	void addStandardDeck(vector<Card> &Deck)
	{
		...
		Card FiveHearts("Five of Hearts", 5, 5);
		Deck.push_back(FiveHearts);

		Card FiveDiamonds("Five of Diamonds", 5, 5);
		Deck.push_back(FiveDiamonds);

		Card FiveClubs("Five of Clubs", 5, 5);
		...
		Card SixHearts("Six of Hearts", 6, 6);
		Deck.push_back(SixHearts);

		Card SixDiamonds("Six of Diamonds", 6, 6);
		Deck.push_back(SixDiamonds);

		Card SixClubs("Six of Clubs", 6, 6);
		...
		Card SevenHearts("Seven of Hearts", 7, 7);
		Deck.push_back(SevenHearts);

		Card SevenDiamonds("Seven of Diamonds", 7, 7);
		Deck.push_back(SevenDiamonds);

		Card SevenClubs("Seven of Clubs", 7, 7);
		...
		Card EightHearts("Eight of Hearts", 8, 8);
		Deck.push_back(EightHearts);

		Card EightDiamonds("Eight of Diamonds", 8, 8);
		Deck.push_back(EightDiamonds);

		Card EightClubs("Eight of Clubs", 8, 8);
		...
		Card NineHearts("Nine of Hearts", 9, 9);
		Deck.push_back(NineHearts);

		Card NineDiamonds("Nine of Diamonds", 9, 9);
		Deck.push_back(NineDiamonds);

		Card NineClubs("Nine of Clubs", 9, 9);
		...
		Card TenHearts("Ten of Hearts", 10, 10);
	...
	void draw(vector<Card> &Deck, vector<Card> &Hand, vector<Card> &Graveyard, int &value, bool &bust)
	{
		...
		if (value > 21)
		{
			...
			{
				if (Hand[i].getMinValue() != Hand[i].getValue() && !Hand[i].getMinValueUsed()) //if it's a multivalued card and the value hasn't changed
					{
						Hand[i].useMinValue();
